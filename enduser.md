...
layout: page
title: Agreement
subtitle: End user software and license agreement
---
...
## Definitions
* **“We”** a.k.a. “us”, or “themaphack.com”. Developer(s) of all mods in this website.
* **“Documentation”** the detailed information about the Software, its features and the system requirements as made available on the website of themaphack.com, as amended from time to time.
...
* **“Trial version”** the license for the Software for the term of N days to Use the Stable version of Software for the sole purpose of testing and evaluating the Software. (N will be decided by us in future). This license is when Themaphack mods reaches v1.0.
...
Themaphack mods is a work in progress, meaning that a lot will change in the near future. We reserve the right to update the Website and these Terms of Service from time to time, at our discretion. We will make sure to announce any major change in a prominent way.
Your continued use of our products following the publishing of updated License Agreement means that you accept and agree to the changes.
The published License Agreement not only applies to current beta versions, but also applies to all versions and future updates of our products.
...
In order to be able to install the Software and receive Updates and upgrades, Your android phone shall have access to the Internet and shall meet the system requirements described in the Documentation that can be found on the webpage: https://themaphack.com/faq The system requirements may be changed in future updates.
You shall Use the Beta version, Full version, or Trial version in accordance with applicable laws, and without prior written approval of us, you shall not:
...
Use beta version or Trial version for commercial usage, without a license code.
...
Use Beta or Trial version for more than allowed evaluation period, which is 15 days.
...
Certain components of the Software are Open Source Software and licensed under the terms of the applicable license(s) of the Open Source Software.
You are allowed to use Full version on any devices you own, manage or have privilege to install and run apps on it. Without extra permission from us, one license can activate Meta mods on unlimited devices at the same time You are allowed to use the Full version for personal purposes, commercial purposes, and other purposes excluding clause 4.2.
We reserve every rights, including ending customer support, revoke your license code, or take future legal steps if you break the restrictions.
...
You could upgrade or downgrade our mods as you like, but we will delete older versions from our website after a long time period or we find it contains serious bugs.
...
For issues about Themaphack mods, please contact us and provide necessary information for us to locate the issue, please notice:
...
## 6. Use of data
See our [Private Policy.](https://themaphack.com/privacy)
...
The limitations of liability referred to in clause 8.1 shall not apply in the event that: (i) any negligence on the part of Themaphack leads to death or physical injury or (ii) damages arise from the intent, willful misconduct or gross negligence of us or the management of us.
## 9. Governing law
These Terms are governed by the law of the place where the Owner is based (Jakarta, Indonesia), as disclosed in the relevant section of this document, without regard to conflict of laws principles.
...
The exclusive competence to decide on any controversy resulting from or connected to these Terms lies with the courts of the place where the Owner is based (Jakarta, Indonesia), as displayed in the relevant section of this document.
...
Trial version will terminate automatically at the end of the applicable license term, unless renewed or Activated prior to the end of the applicable license term.
We are entitled to terminate the Full version or Trial version by blocking the License Key during the license term with immediate effect and without prior notice in the event You fail to comply with the terms in this EULA, in the event You fail to pay Your (subscription) fee for the License Key within the applicable payment term, or in the event Themaphack is required to do so by law or an order of an applicable court.
Upon termination of the Full version or Trial version, You shall cease all use of the Software and shall destroy all copies thereof.
You acknowledge that the provisions of this EULA, which by their nature are intended to survive termination, will remain in effect after termination of this EULA.
## 13. Feedback
We welcome any comment, question and communication at <a href="mailto:dhanumurtianggoro@gmail.com">Developer email</a>